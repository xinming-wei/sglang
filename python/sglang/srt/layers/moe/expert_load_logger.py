"""Zero-overhead expert load logging for MoE inference benchmarking.
...
class ExpertLoadLogger:
    ...
    def init_tensors(
        ...
        logger.info(
            ...
            "num_local_experts=%d, max_steps=%d, save_path=%s",
            global_rank,
            ep_rank,
            ep_size,
            num_local_experts,
    ...
    def _do_save(self):
        ...
        np.savez_compressed(
            ...
            prefill_loads=prefill_data,
            decode_loads=decode_data,
        )
